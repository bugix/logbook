...
import ch.unibas.medizin.logbook.client.a_nonroo.app.LogBookShell;
...
public class LogBookAdminNav extends Composite {
	...
	private static LogBookAdminNavUiBinder uiBinder = GWT
			.create(LogBookAdminNavUiBinder.class);
	...
	public void tabSelectionChanged(SelectionEvent<Integer> event)
	{
		 ...
		 /*else if(event.getSelectedItem() ==1)
		 {
			 logBookNav.placeController.goTo(new MainLoginPlace("MainLoginPlace"));
		 }*/
