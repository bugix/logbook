...
public interface SkillView extends IsWidget {
	...
	interface Delegate {
		...
		void findProgressOfMainClassification(MainClassificationProxy mProxy, int row, int i, StudentProxy student);

		void findProgressOfClassificationTopic(ClassificationTopicProxy cProxy, int row, int i, StudentProxy student);

		void findProgressOfTopic(TopicProxy tproxy, int row, int i, StudentProxy student);
	...
	void setMainClassificationSuggestBox(DefaultSuggestBox<MainClassificationProxy, EventHandlingValueHolderItem<MainClassificationProxy>> mainClassificationSuggestBox);

	void setClassificationTopicSuggestBox(DefaultSuggestBox<ClassificationTopicProxy, EventHandlingValueHolderItem<ClassificationTopicProxy>> classificationTopicSuggestBox);

	DefaultSuggestBox<TopicProxy, EventHandlingValueHolderItem<TopicProxy>> getTopicSuggestBox();

	void setTopicSuggestBox(DefaultSuggestBox<TopicProxy, EventHandlingValueHolderItem<TopicProxy>> topicSuggestBox);
