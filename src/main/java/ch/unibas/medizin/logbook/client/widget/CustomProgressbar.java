 ...
 * </ul>
 */
public class CustomProgressbar extends Widget implements ResizableWidget {
	...
	public abstract static class TextFormatter {
		 ...
		 */
		protected abstract String getText(CustomProgressbar bar, double curProgress);
	}
	 ...
	 *            the current progress
	 */
	public CustomProgressbar(double curProgress) {
	 ...
	 *            the maximum progress
	 */
	public CustomProgressbar(double minProgress, double maxProgress) {
	 ...
	 *            the current progress
	 */
	public CustomProgressbar(double minProgress, double maxProgress, double curProgress) {
	 ...
	 *            the text formatter
	 */
	public CustomProgressbar(double minProgress, double maxProgress, double curProgress, TextFormatter textFormatter) {
	...
	protected String generateText(double curProgress) {
		if (textFormatter != null) {
			...
			return DECIMAL_FORMAT.format((getPercent()));
		}
	}
	...
	private void updateTextStyle(double percent) {
