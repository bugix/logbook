  ...
  private void cellListStyleInitializer() {
    cellListStyle = new com.google.gwt.user.cellview.client.CellList.Style() {
      ...
      public String getText() {
        return (".GAK-4ALBAB,.GAK-4ALBCB{cursor:" + ("pointer")  + ";zoom:" + ("1")  + ";}.GAK-4ALBBB{background:" + ("#ffc")  + ";}.GAK-4ALBDB{height:" + ((CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getSafeUri().asString() + "\") -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getLeft() + "px -" + (CellList_Resources_default_InlineClientBundleGenerator.this.cellListSelectedBackground()).getTop() + "px  repeat-x")  + ";background-color:" + ("#628cd5")  + ";color:" + ("white")  + ";height:" + ("auto")  + ";overflow:" + ("visible")  + ";}");
      }
