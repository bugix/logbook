...
public class OperationMessageAutoBean extends com.google.web.bindery.autobean.shared.impl.AbstractAutoBean<com.google.web.bindery.requestfactory.shared.messages.OperationMessage> {
  ...
  @Override protected com.google.web.bindery.requestfactory.shared.messages.OperationMessage createSimplePeer() {
    return new com.google.web.bindery.requestfactory.shared.messages.OperationMessage() {
      ...
      public com.google.web.bindery.requestfactory.shared.WriteOperation getOperation()  {
        return (com.google.web.bindery.requestfactory.shared.WriteOperation) OperationMessageAutoBean.this.getOrReify("O");
      }
      public com.google.web.bindery.requestfactory.shared.messages.IdMessage.Strength getStrength()  {
        return (com.google.web.bindery.requestfactory.shared.messages.IdMessage.Strength) OperationMessageAutoBean.this.getOrReify("R");
      }
      public int getClientId()  {
        java.lang.Integer toReturn = OperationMessageAutoBean.this.getOrReify("C");
        return toReturn == null ? 0 : toReturn;
      }
      public int getSyntheticId()  {
        java.lang.Integer toReturn = OperationMessageAutoBean.this.getOrReify("Y");
        return toReturn == null ? 0 : toReturn;
      }
      public java.lang.String getServerId()  {
        return (java.lang.String) OperationMessageAutoBean.this.getOrReify("S");
      }
      public java.lang.String getTypeToken()  {
        return (java.lang.String) OperationMessageAutoBean.this.getOrReify("T");
      }
      public java.lang.String getVersion()  {
        return (java.lang.String) OperationMessageAutoBean.this.getOrReify("V");
      }
      public java.util.Map getPropertyMap()  {
        return (java.util.Map) OperationMessageAutoBean.this.getOrReify("P");
      }
      public void setClientId(int value)  {
        OperationMessageAutoBean.this.setProperty("C", value);
      }
      public void setOperation(com.google.web.bindery.requestfactory.shared.WriteOperation value)  {
        OperationMessageAutoBean.this.setProperty("O", value);
      }
      public void setPropertyMap(java.util.Map map)  {
        OperationMessageAutoBean.this.setProperty("P", map);
      }
      public void setServerId(java.lang.String value)  {
        OperationMessageAutoBean.this.setProperty("S", value);
      }
      public void setStrength(com.google.web.bindery.requestfactory.shared.messages.IdMessage.Strength value)  {
        OperationMessageAutoBean.this.setProperty("R", value);
      }
      public void setSyntheticId(int value)  {
        OperationMessageAutoBean.this.setProperty("Y", value);
      }
      public void setTypeToken(java.lang.String value)  {
        OperationMessageAutoBean.this.setProperty("T", value);
      }
      public void setVersion(java.lang.String version)  {
        OperationMessageAutoBean.this.setProperty("V", version);
      }
    };
  }
