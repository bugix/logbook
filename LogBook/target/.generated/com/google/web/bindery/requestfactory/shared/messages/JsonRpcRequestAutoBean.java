...
public class JsonRpcRequestAutoBean extends com.google.web.bindery.autobean.shared.impl.AbstractAutoBean<com.google.web.bindery.requestfactory.shared.messages.JsonRpcRequest> {
  ...
  @Override protected com.google.web.bindery.requestfactory.shared.messages.JsonRpcRequest createSimplePeer() {
    return new com.google.web.bindery.requestfactory.shared.messages.JsonRpcRequest() {
      ...
      public int getId()  {
        java.lang.Integer toReturn = JsonRpcRequestAutoBean.this.getOrReify("id");
        return toReturn == null ? 0 : toReturn;
      }
      public java.lang.String getApiVersion()  {
        return (java.lang.String) JsonRpcRequestAutoBean.this.getOrReify("apiVersion");
      }
      public java.lang.String getMethod()  {
        return (java.lang.String) JsonRpcRequestAutoBean.this.getOrReify("method");
      }
      public java.lang.String getVersion()  {
        return (java.lang.String) JsonRpcRequestAutoBean.this.getOrReify("jsonrpc");
      }
      public java.util.Map getParams()  {
        return (java.util.Map) JsonRpcRequestAutoBean.this.getOrReify("params");
      }
      public void setApiVersion(java.lang.String version)  {
        JsonRpcRequestAutoBean.this.setProperty("apiVersion", version);
      }
      public void setId(int id)  {
        JsonRpcRequestAutoBean.this.setProperty("id", id);
      }
      public void setMethod(java.lang.String method)  {
        JsonRpcRequestAutoBean.this.setProperty("method", method);
      }
      public void setParams(java.util.Map params)  {
        JsonRpcRequestAutoBean.this.setProperty("params", params);
      }
      public void setVersion(java.lang.String version)  {
        JsonRpcRequestAutoBean.this.setProperty("jsonrpc", version);
      }
    };
  }
