...
public class MainClassificationEditView_description_Context extends com.google.gwt.editor.client.impl.AbstractEditorContext<java.lang.String> {
  private final logbook.client.managed.proxy.MainClassificationProxy parent;
  public MainClassificationEditView_description_Context(logbook.client.managed.proxy.MainClassificationProxy parent, com.google.gwt.editor.client.Editor<java.lang.String> editor, String path) {
    super(editor,path);
    this.parent = parent;
  }
