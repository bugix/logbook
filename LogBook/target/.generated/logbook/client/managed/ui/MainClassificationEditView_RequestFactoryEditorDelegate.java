...
public class MainClassificationEditView_RequestFactoryEditorDelegate extends com.google.web.bindery.requestfactory.gwt.client.impl.RequestFactoryEditorDelegate {
  private logbook.client.managed.ui.MainClassificationEditView editor;
  @Override protected logbook.client.managed.ui.MainClassificationEditView getEditor() {return editor;}
  protected void setEditor(com.google.gwt.editor.client.Editor editor) {this.editor=(logbook.client.managed.ui.MainClassificationEditView)editor;}
  ...
  @Override public void accept(com.google.gwt.editor.client.EditorVisitor visitor) {
    ...
    {
      logbook.client.managed.ui.MainClassificationEditView_description_Context ctx = new logbook.client.managed.ui.MainClassificationEditView_description_Context(getObject(), editor.description.asEditor(), appendPath("description"));
