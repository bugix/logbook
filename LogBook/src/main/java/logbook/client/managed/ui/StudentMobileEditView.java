...
public class StudentMobileEditView extends StudentMobileEditView_Roo_Gwt {
    ...
    private static logbook.client.managed.ui.StudentMobileEditView instance;
    ...
    public static logbook.client.managed.ui.StudentMobileEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<logbook.client.managed.proxy.StudentProxy, logbook.client.managed.ui.StudentMobileEditView> createEditorDriver() {
