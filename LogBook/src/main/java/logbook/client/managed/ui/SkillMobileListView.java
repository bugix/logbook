...
public class SkillMobileListView extends SkillMobileListView_Roo_Gwt {

    private static logbook.client.managed.ui.SkillMobileListView instance;

    public SkillMobileListView() {
        super("New Skill", new CellRenderer());
        init();
    }

    public static logbook.client.managed.ui.SkillMobileListView instance() {
        if (instance == null) {
            instance = new SkillMobileListView();
        }
        return instance;
    }
    ...
    private static class CellRenderer extends AbstractSafeHtmlRenderer<SkillProxy> {
        ...
        @Override
        public SafeHtml render(SkillProxy value) {
            if (value == null) {
