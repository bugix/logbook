...
public class AdministratorMobileDetailsView extends AdministratorMobileDetailsView_Roo_Gwt {
    ...
    private static logbook.client.managed.ui.AdministratorMobileDetailsView instance;
    ...
    public static logbook.client.managed.ui.AdministratorMobileDetailsView instance() {
        if (instance == null) {
