...
public abstract class TopicMobileEditView_Roo_Gwt extends Composite implements View<TopicMobileEditView> {
    ...
    public void setClassificationTopicPickerValues(Collection<logbook.client.managed.proxy.ClassificationTopicProxy> values) {
        classificationTopic.setAcceptableValues(values);
    }
