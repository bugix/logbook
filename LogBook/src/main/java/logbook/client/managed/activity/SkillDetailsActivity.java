...
public class SkillDetailsActivity extends SkillDetailsActivity_Roo_Gwt {

    public SkillDetailsActivity(EntityProxyId<logbook.client.managed.proxy.SkillProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, ProxyDetailsView<logbook.client.managed.proxy.SkillProxy> view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(SkillProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((SkillProxy) proxy);
