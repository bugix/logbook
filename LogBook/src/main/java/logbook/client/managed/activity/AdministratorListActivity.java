...
public class AdministratorListActivity extends AdministratorListActivity_Roo_Gwt {

    public AdministratorListActivity(ApplicationRequestFactory requests, ProxyListView<logbook.client.managed.proxy.AdministratorProxy> view, PlaceController placeController) {
    ...
    protected Request<java.util.List<logbook.client.managed.proxy.AdministratorProxy>> createRangeRequest(Range range) {
