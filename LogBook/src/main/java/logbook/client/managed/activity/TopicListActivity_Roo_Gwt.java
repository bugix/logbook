...
public abstract class TopicListActivity_Roo_Gwt extends AbstractProxyListActivity<TopicProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public TopicListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<logbook.client.managed.proxy.TopicProxy> view, Class<logbook.client.managed.proxy.TopicProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<java.lang.Long> callback) {
        requests.topicRequest().countTopics().fire(callback);
    }
}
