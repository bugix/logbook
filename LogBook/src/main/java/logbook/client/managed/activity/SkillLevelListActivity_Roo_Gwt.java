...
public abstract class SkillLevelListActivity_Roo_Gwt extends AbstractProxyListActivity<SkillLevelProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public SkillLevelListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<logbook.client.managed.proxy.SkillLevelProxy> view, Class<logbook.client.managed.proxy.SkillLevelProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<java.lang.Long> callback) {
        requests.skillLevelRequest().countSkillLevels().fire(callback);
    }
}
