...
public class StudentEditActivityWrapper extends StudentEditActivityWrapper_Roo_Gwt {
    ...
    public StudentEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<logbook.client.managed.proxy.StudentProxy> proxyId) {
    ...
    public interface View<V extends logbook.client.scaffold.place.ProxyEditView<logbook.client.managed.proxy.StudentProxy, V>> extends ProxyEditView<StudentProxy, V> {

        void setGenderPickerValues(Collection<logbook.shared.Gender> values);
