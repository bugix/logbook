...
import logbook.server.domain.TopicIntegrationTest;
...
privileged aspect TopicIntegrationTest_Roo_IntegrationTest {
    ...
    @Test
    public void TopicIntegrationTest.testFlush() {
        Topic obj = dod.getRandomTopic();
        Assert.assertNotNull("Data on demand for 'Topic' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Topic' failed to provide an identifier", id);
        obj = Topic.findTopic(id);
        Assert.assertNotNull("Find method for 'Topic' illegally returned null for id '" + id + "'", obj);
        boolean modified =  dod.modifyTopic(obj);
        Integer currentVersion = obj.getVersion();
        obj.flush();
        Assert.assertTrue("Version for 'Topic' failed to increment on flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
    
    @Test
    public void TopicIntegrationTest.testMergeUpdate() {
        Topic obj = dod.getRandomTopic();
        Assert.assertNotNull("Data on demand for 'Topic' failed to initialize correctly", obj);
        Long id = obj.getId();
        Assert.assertNotNull("Data on demand for 'Topic' failed to provide an identifier", id);
        ...
        boolean modified =  dod.modifyTopic(obj);
        Integer currentVersion = obj.getVersion();
        Topic merged = obj.merge();
        obj.flush();
        Assert.assertEquals("Identifier of merged object not the same as identifier of original object", merged.getId(), id);
        Assert.assertTrue("Version for 'Topic' failed to increment on merge and flush directive", (currentVersion != null && obj.getVersion() > currentVersion) || !modified);
    }
